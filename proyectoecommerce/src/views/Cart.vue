<template>
  ...
  <b-row>
    <b-col class="text-center">
     <b-table bordered  hover :items="cart" :fields="fields">
      ...
      <b-col class="text-center">
            <b-img style="max-width: 5rem;" :src= "require(`@/assets/img/fruits/juego${data.item.id}.jpeg`)" fluid alt="Responsive image"></b-img>
      </b-col>
  ...
  <b-row class="mt-4 text-center" v-if="cart.length > 0">
   ...
   <b-modal hide-header-close no-close-on-esc no-close-on-backdrop ref="modal-1" centered title="Compra Confirmada ">
